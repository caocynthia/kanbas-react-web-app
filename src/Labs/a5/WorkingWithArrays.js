...
function WorkingWithArrays() {
  ...
  return (
    <div>
      ...
      <button className="btn btn-light" onClick={() => updateTitle(id, title)}>
        Update Todo Title
      </button>
      <button className="btn btn-light" onClick={createTodo}>
        Create Todo
      </button>
      <button className="btn btn-light" onClick={postTodo}>
        Post Todo
      </button>
      <input
        className="form-control"
      ...
      <h2>Fetch Array</h2>
      <a href="http://localhost:4000/a5/todos" className="btn btn-light">
        Fetch Todos
      </a>
    </div>
  );
